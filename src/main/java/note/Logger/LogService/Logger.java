...
public class Logger extends Thread implements LoggerInt {
    ...
    // singleton instance ( can be turned into a singleton )
    ...
    public Logger(String logDefaultDir, int maxLogFileSize, boolean logTerminalOutput) {
        ...
        // can be turned into a singleton
        // instance = this;
    }
    ...
    @Override
    public String readLastEntry() throws IOException {
        return new BufferedReader(new InputStreamReader(new FileInputStream(currentWritingFile))).readLine();
    }
